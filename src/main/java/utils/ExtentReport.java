...
public class ExtentReport {
	...
	public static void createReportFile(String Step_details)   {
	    ...
	    htmlReporter.config().setDocumentTitle("Intely Health Extent Report");
	    htmlReporter.config().setReportName("Intely Health Test Report");
	...
	public static void updateReportName(String Step_details) {
	 ...
	 public static ExtentTest createReportName(String step_details){
		...
		childLogger = logger.createNode("System Name - QA1 MACHINE ");//+ System.getenv("COMPUTERNAME"));
