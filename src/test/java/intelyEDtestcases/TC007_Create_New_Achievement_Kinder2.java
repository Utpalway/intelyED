...
public class TC007_Create_New_Achievement_Kinder2 extends TestBase {

	@Test
	public void TC007_Create_New_Achievement() throws Throwable {
		
		ArrayList<String> TestcaseName;
		ExcelDataDrivenTest d = new ExcelDataDrivenTest();
		TestcaseName =d.getData("TC007_Create_New_Achievement_Kinder2");
